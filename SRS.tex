...
\usepackage{xcolor}<?xml version="1.0" encoding="UTF-8"?>
<map name="Root Concept">
    
    <node name="Branch A">
        <node name="Sub-Branch A1" />
        <node name="Sub-Branch A2" />
        <node name="Sub-Branch A3" />
    </node>
    
    <node name="Branch B">
        <node name="Sub-Branch B1" />
        <node name="Sub-Branch B2" />
        <node name="Sub-Branch B3" />
    </node>
    
    <node name="Branch C">
        <node name="Sub-Branch C1" />
        <node name="Sub-Branch C2" />
        <node name="Sub-Branch C3" />
    </node>
